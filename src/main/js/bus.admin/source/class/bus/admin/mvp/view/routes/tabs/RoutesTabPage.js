...
members : {
 		 ...
 		 */
 		 __initWidgets : function() {
 		 	...
 		 	this.__mainContainer.addListener("resize",
 		 		this.__onResizeMainContainer, this);
		 ...
		 */
 		...
 		on_loadRoutesList : function(e) {
 			var data = e.getData();
 			this.__tableRoutes.getSelectionModel().resetSelection();
 			this.setStatusForWidgets(this._routesPage.getStatus());
 			if (data == null || data.error == true) {
 			...
 			this.__tableRoutes.getTableModel().setData(rowData);
		...
		__onResizeMainContainer : function(e) {
			this.debug("__onResizeMainContainer()");
