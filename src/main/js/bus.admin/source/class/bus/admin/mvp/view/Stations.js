...
qx.Class.define("bus.admin.mvp.view.Stations", {
			...
			construct : function() {
				...
				this.__desktop = new qx.ui.window.Desktop().set({
							decorator : new qx.ui.decoration.Single(10, null,
									"#ddd")
						});
			...
			members : {
				...
				__createWindow1 : function() {
					...
					win.addListener("move", function(e) {
								this.debug("Moved to: " + e.getData().left
										+ "x" + e.getData().top);
							}, this);

					// Test for resize listener
					win.addListener("resize", function(e) {
								this.debug("Resized to: " + e.getData().width
										+ "x" + e.getData().height);
							}, this);
				...
				__createWindow2 : function() {
					var win = new qx.ui.window.Window("Second Window",
							"icon/16/apps/internet-feed-reader.png");
					win.setLayout(new qx.ui.layout.VBox(10));
					win.setStatus("Application is ready");

					var atom = new qx.ui.basic.Atom("The second window",
					...
					for (var i = 0; i < edges.length; i++) {
						...
						resizable.bind("value", win, "resizable"
										+ qx.lang.String.firstUp(edge));
				...
				__createWindow3 : function() {
					var win = new qx.ui.window.Window("Third Window",
					...
					var btn1 = new qx.ui.form.Button("Open Modal Dialog 1",
							"icon/16/apps/office-calendar.png");
				...
				__getModalWindow2 : function() {
					...
					var btn3 = new qx.ui.form.Button("Yes",
					...
					var btn4 = new qx.ui.form.Button("No",
